...
const menuItems: MenuItem[] = [
  ...
  {
    label: "Değişiklik ve Denetim",
    href: "/denetim-merkezi",
...
export default function UstGezinme() {
  ...
  const visibleItems = useMemo(
    () =>
      fullAccess
        ? menuItems
        : menuItems.filter((item) => modules.includes(item.moduleKey)),
    [fullAccess, modules],
  );
  ...
  return (
    <>
      ...
      <button
        type="button"
        className={`menuShade ${menuOpen ? "open" : ""}`}
      ...
      <style jsx global>{`
        ...
        .desktopLinks a.active {
          color: #fff;
          background: #1769e8;
          box-shadow: 0 7px 17px rgba(23, 105, 232, 0.22);
        }
        .navLoading {
          color: #8492a6;
          font-size: 11px;
        ...
        .mobileDrawer {
          ...
          box-shadow: -24px 0 60px rgba(3, 12, 28, 0.38);
          overflow-y: auto;
        }
        .mobileDrawer.open {
        ...
        .mobileDrawer header div {
          display: grid;
          gap: 4px;
        }
        .mobileDrawer header small {
          color: #82b8ff;
          font-size: 10px;
          font-weight: 900;
          letter-spacing: 1px;
        }
        .mobileDrawer header strong {
          font-size: 21px;
        }
        .mobileDrawer header button {
          width: 42px;
          height: 42px;
        ...
        .mobileDrawer nav a.active {
          color: #fff;
          background: #1769e8;
          box-shadow: 0 8px 22px rgba(23, 105, 232, 0.25);
        }
        .drawerLogout {
          width: 100%;
          min-height: 50px;
