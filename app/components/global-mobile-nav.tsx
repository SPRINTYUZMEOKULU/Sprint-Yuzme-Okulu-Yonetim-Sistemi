    ...
    <>
      ...
      <style jsx global>{`
        ...
        @media(max-width:820px){
          ...
          .globalMobileSearch{min-width:0}.globalMobileSearch .searchBox{min-height:48px!important;border-radius:14px!important;background:#fff!important;border:1px solid #d8e2ef!important;box-shadow:none!important}.globalMobileSearch kbd{display:none!important}
